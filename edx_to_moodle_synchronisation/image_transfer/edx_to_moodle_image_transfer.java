...
public class edx_to_moodle_image_transfer
{
    ...
    public static void main(String[] args) throws ClassNotFoundException, IOException, SQLException, NoSuchAlgorithmException
    {
    	Class.forName("com.mysql.jdbc.Driver");
            ...
            String line;
            Process p = Runtime.getRuntime().exec(new String[]{"/bin/bash", "-c", "php /home/rajarshi/edx_to_moodle_synchronisation/image_transfer/contenthash.php"});
            ...
            p = Runtime.getRuntime().exec(new String[]{"/bin/bash", "-c", "file --mime-type -b /home/rajarshi/edx_to_moodle_synchronisation/image_transfer/image"});
            ...
            sql="Insert into mdl_files (contenthash,pathnamehash,contextid,component,filearea,itemid,filepath,filename,userid,filesize,mimetype,status,source,author,license,timecreated,timemodified,sortorder)"
              	 + "values ('"+contenthash+"','"+pathnamehash+"','"+contextId+"','"+component+"','"+filearea+"','"+itemid+"','"+filepath+"','"+filename+"',2,'"+filesize+"','"+mimetype+"',0,'"+sourcename+"','Rajarshi Sarkar','allrightsreserved',0,0,0)";
...
//for mdl_context.................................
            ...
            while(rs.next())
            {
         	   ...
         	   if(coursenumber.compareTo(courseid)==0)
         		   break;
            }
 ...
 //for mdl_file part 2...........................
            ...
            sql="Insert into mdl_files (contenthash,pathnamehash,contextid,component,filearea,itemid,filepath,filename,userid,filesize,mimetype,status,source,author,license,timecreated,timemodified,sortorder)"
               	 + "values ('"+contenthash+"','"+pathnamehash+"','"+contextId+"','"+component+"','"+filearea+"','"+itemid+"','"+filepath+"','"+filename+"',2,'"+filesize+"','"+mimetype+"',0,'"+filename+"','Rajarshi Sarkar','allrightsreserved',0,0,1)";
            stmt.execute(sql);
           ...
           //for mdl_resource..............................................................
            ...
            sql="insert into mdl_resource (course,name,intro,introformat,tobemigrated,legacyfiles,display,displayoptions,filterfiles,revision,timemodified)"
         		   + "values ('"+courseid1+"','"+filename.substring(0, filename.length()-4)+"','"+intro+"',1,0,0,0,'"+displayoptions+"',0,1,0)";
