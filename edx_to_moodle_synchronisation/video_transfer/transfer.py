...
if script_response_a.count("\n")>7 and 'Exception' not in script_response_a:
	roc = subprocess.Popen("javac -classpath /home/rajarshi/edx_to_moodle_synchronisation/video_transfer/mongo-2.10.1.jar:/home/rajarshi/edx_to_moodle_synchronisation/video_transfer/mysql-connector-java-5.0.8-bin.jar:/home/rajarshi/edx_to_moodle_synchronisation/video_transfer/sqlite-jdbc-3.7.2.jar edx_to_moodle_video_moodle_courseid.java", shell=True, stdout=subprocess.PIPE)
	proc = subprocess.Popen("java -classpath '.:/home/rajarshi/edx_to_moodle_synchronisation/video_transfer/mongo-2.10.1.jar:/home/rajarshi/edx_to_moodle_synchronisation/video_transfer/mysql-connector-java-5.0.8-bin.jar:/home/rajarshi/edx_to_moodle_synchronisation/video_transfer/sqlite-jdbc-3.7.2.jar' edx_to_moodle_video_moodle_courseid", shell=True, stdout=subprocess.PIPE)
