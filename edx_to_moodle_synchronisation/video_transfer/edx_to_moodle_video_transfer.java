...
public class edx_to_moodle_video_transfer
{
    ...
    //start of mdl_course_modules...............................................
                ...
                sql="insert into mdl_url (course,name,intro,introformat,externalurl,display,displayoptions,parameters,timemodified)"
                        +" values('"+id+"','"+video_name_to_be_sent+"','<p>No Description Available</p>',1,'"+video_to_be_sent+"',1,'"+displayoption+"','a:0:{}',0)";
                System.out.println(sql);
                stmt.execute(sql);
