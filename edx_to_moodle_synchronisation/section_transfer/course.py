...
def course_handler(request, course_key_string=None):
    ...
    """
    if course_key_string != None:
		os.system('python /home/rajarshi/edx_to_moodle_synchronisation/course_transfer/transfer.py')
		os.system('python /home/rajarshi/edx_to_moodle_synchronisation/section_transfer/transfer.py')
