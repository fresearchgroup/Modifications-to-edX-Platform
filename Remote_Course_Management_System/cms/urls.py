...
#===========================================  Changes   ===========================================================#
    url(r'^rcms/(?P<success>[^/]+)?$','rcms.views.rcms',name='rcms'),
    url(r'^update_course/(?P<courseid>\w+)/$','rcms.views.update_course',name='update_course'),
    url(r'^transferData/$','rcms.views.transfer',name='transfer'),
    url(r'^offercourse/$','rcms.views.offercourse',name = 'offercourse'),
    url(r'^unoffercourse/$','rcms.views.unoffercourse',name = 'unoffercourse'),
    url(r'^commitcourse/$','rcms.views.commitcourse',name = 'commitcourse'),
    url(r'^uncommitcourse/$','rcms.views.uncommitcourse',name = 'uncommitcourse'),
